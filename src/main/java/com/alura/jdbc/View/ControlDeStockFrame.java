    ...
    private void modificar() {
        ...
        Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                    ...
                    String nombre = String.valueOf(modelo.getValueAt(tabla.getSelectedRow(), 1).toString());
                    String descripcion = String.valueOf(modelo.getValueAt(tabla.getSelectedRow(), 2).toString());
